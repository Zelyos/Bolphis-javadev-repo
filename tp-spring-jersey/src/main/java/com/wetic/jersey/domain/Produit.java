...
public class Produit implements Serializable {
    ...
    public Produit(String libelle , Float prix,Integer qteStock, String description ){
    ...
    public Produit detailsFactures(Set<DetailsFacture> detailsFactures) {
        this.detailsFactures = detailsFactures;
        return this;
    }

    public Produit addDetailsFactures(DetailsFacture detailsFacture) {
        this.detailsFactures.add(detailsFacture);
        detailsFacture.setProduit(this);
        return this;
    }

    public Produit removeDetailsFactures(DetailsFacture detailsFacture) {
        this.detailsFactures.remove(detailsFacture);
        detailsFacture.setProduit(null);
        return this;
    }

    public void setProduits(Set<DetailsFacture> detailsFactures) {
        this.detailsFactures = detailsFactures;
    }
